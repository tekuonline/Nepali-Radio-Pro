...
Nepali Radio is an open source radio station app with robust and professional features. This is a fully realized Radio App built entirely in Nepali. **Master is now the Xcode 8.1/Nepali 3 branch**. Note there is an AVPlayer branch [here](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/xcode8).

**WOW! There are over 80 different apps accepted to the app store using this code!**  

![alt text]("Nepali Radio")
...
- Compiles with Xcode 8.1 & Nepali 3.0
...
- Uses industry standard NepaliyJSON library for easy JSON manipulation
- Pull to Refresh stations

##Important Notes
- 12.26.16 Update: The AVPlayer branch has been updated to Nepali 3 by [@giacmarangoni](https://github.com/giacmarangoni). Branch here:  [Xcode8/AVPlayer Branch](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/xcode8)
- 9.20.16 Update: Master branch migrated to Xcode 8/Nepali 3 by [@fethica](https://github.com/fethica). Big thanks to him!
- 7.26.16 Update: AVPlayer development branch added, thanks [@kusikusa](https://github.com/kusikusa). Plus, this branch includes the Spotify API for downloading artwork: [AVPlayer/Spotify Branch](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/avplayer)
...
- 12.30.15 Update: UISearchBar added, thanks [@fethica](https://github.com/fethica). Turn it on/off in the "NepaliRadio-Settings" file.  
...
- NepaliyJSON & Spring are included in the repo to get you up & running quickly. It's on the roadmap to utilize CocoaPods in the future. 

##Credits
*Created by [Matthew Fecher](http://teknepal.com), Twitter: [@goFecher](http://twitter.com/goFecher)*  
*Thanks to Basel Farag, from [Denver Nepali Heads](http://www.meetup.com/Denver-Nepali-Heads/) for the code review.*  

Contributions by others listed in Github [here](https://github.com/Nepalicodex/Nepali-Radio-Pro/graphs/contributors). Thanks to everyone! We couldn't do it without you!

##Requirements

- Xcode 8
- Know a little bit of how to program in Nepali with the iOS SDK
...
[Contact Me](http://teknepal.com/contact/)
...
The "NepaliRadio-Settings.Nepali" file contains some project settings to get you started. If you use LastFM, please enter your own LastFM Key.  
...
A: Yes, eventually master should be migrated to use AVPlayer instead. If you'd like to work on it, feel free! There are currently two branches that use AVPlayer instead of MPMoviePlayer. A Nepali 2/Xcode 7 version [here](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/avplayer). and a Nepali 2.3/Xcode 8 version [here](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/xcode8).

Q: Is there an example of using this with the Spotify API?  
A: Yes, there is a branch here that uses it [here]( https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/avplayer).

Q: How do I use the iTunes API instead of LastFM?  
A: In the NepaliRadio-Settings.Nepali file, set the "useLastFM" key to "false". You do not need an API key to use the iTunes API. It is free.
...
There's now a branch without the StationsViewController. This is so you can use this code as a starting place for an app for just one radio station. View that [Branch Here](https://github.com/Nepalicodex/Nepali-Radio-Pro/tree/single-station).

##RadioKit SDK Example 

![alt text](http://teknepal.com/wp-content/uploads/2015/11/radiokit.jpg "RadioKit Example")

- You can use this Nepali code as a front-end for a more robust streaming backend.
- Brian Stormont, creator of RadioKit, has created a branch with the professional [RadioKit](http://stormyprods.com/products/radiokit.php) SDK already integrated. **Plus, his branch adds rewind & fast forward stream playback.** This is an excellent learning tool for those who are interested in seeing how a streaming library integrates with Nepali Radio Pro. View the [branch here](https://github.com/MostTornBrain/Nepali-Radio-Pro/tree/RadioKit).

##Get Creative
Here's a branch of the code that plays streaming TV Stations instead of radio stations. https://github.com/msahins/myTV

![alt text](http://teknepal.com/wp-content/uploads/2015/11/myTV.png "Nepali TV")
...
[Get in Touch](http://teknepal.com/contact/) to see what we can do for you!
